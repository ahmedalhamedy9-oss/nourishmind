...
const Logo = () => (
  <Link to="/" aria-label="NourishMind — Go to homepage" className="flex items-center shrink-0">
    <img src="/logo.svg" alt="NourishMind logo" style={{ height: '40px', width: 'auto' }} />
  </Link>
);

const Avatar = ({ src, initials, size = 36 }) => (
  src ? (
    <img src={src} alt="Your profile avatar"
    ...
    <div
      ...
      style={{ width:size, height:size, borderRadius:'50%', background:'rgba(74,155,142,0.15)',
...
export const FloatingWhatsApp = () => {
  ...
  return (
    ...
    >
      <svg width="28" height="28" viewBox="0 0 24 24" fill="white" aria-hidden="true" focusable="false">
    ...
    <>
      ...
      <header
        ...
        <div className="w-full px-4 sm:px-6 flex items-center gap-4">
          ...
          <nav aria-label="Main navigation" className="hidden md:flex items-center gap-6 text-sm font-medium ml-4">
          ...
          <div className="ml-auto flex items-center gap-2 sm:gap-3">
            ...
            {currentUser ? (
              <div className="flex items-center gap-2">
                {/* Certificates link */}
                <Link to="/certificates" aria-label="My Certificates"
                ...
                <button onClick={openDash}
                  aria-label="Open my courses dashboard"
                ...
                <button onClick={openDash}
                  aria-label={`Open dashboard for ${displayName || 'Account'}`}
        ...
        <nav id="mobile-nav" aria-label="Mobile navigation"
          ...
          {currentUser && (
            <button onClick={openDash}
              ...
              <span className="ml-auto text-xs" style={{ color:'#5fbfb0' }} aria-hidden="true">View →</span>
            </button>
          )}
