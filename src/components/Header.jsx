...
export const FloatingWhatsApp = () => {
  ...
  const url = isMobile ? `https://wa.me/${num}` : `https://web.whatsapp.com/send?phone=${num}`;
  return (
    <a href={url} target="_blank" rel="noopener noreferrer" title="Chat with us on WhatsApp"
      style={{ position:'fixed', bottom:24, right:24, zIndex:999, width:56, height:56, borderRadius:'50%',
        background:'#25D366', display:'flex', alignItems:'center', justifyContent:'center',
        boxShadow:'0 4px 20px rgba(37,211,102,0.45)', transition:'transform .2s, box-shadow .2s', textDecoration:'none' }}
